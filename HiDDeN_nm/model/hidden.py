...
class Hidden:
    ...
    def train_on_batch(self, batch: list):
        ...
        noise_messages=torch.normal(mean=messages,std=0.1*self.config.std_scale)
        ...
        with torch.enable_grad():
            ...
            # train on fake
            encoded_images, noised_images, decoded_messages = self.encoder_decoder(images, noise_messages)
