...
from PerceptualSimilarity.src.loss.color_wrapper import ColorWrapper, GreyscaleWrapper
from PerceptualSimilarity.src.loss.shift_wrapper import ShiftWrapper
from PerceptualSimilarity.src.loss.watson import WatsonDistance
from PerceptualSimilarity.src.loss.watson_fft import WatsonDistanceFft
from PerceptualSimilarity.src.loss.watson_vgg import WatsonDistanceVgg
from PerceptualSimilarity.src.loss.robust_loss import RobustLoss
from PerceptualSimilarity.src.loss.deep_loss import PNetLin
from PerceptualSimilarity.src.loss.ssim import SSIM
