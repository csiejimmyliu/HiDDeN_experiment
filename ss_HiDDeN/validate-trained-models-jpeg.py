...
def main():
    ...
    parser.add_argument('--q', '-q', default=90, type=float, help='jpeg quality.')
    ...
    for run_name in completed_runs:
        ...
        for image, _ in val_data:
            ...
            losses, (encoded_images, noised_images, decoded_messages) = model.validate_on_batch_jpeg([image, message],100-args.q)
        ...
        # utils.print_progress(losses_accu)
        write_validation_loss(os.path.join(args.runs_root, 'jpeg_validation_run.csv'), losses_accu, run_name,
                              checkpoint['epoch'],
